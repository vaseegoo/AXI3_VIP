...
#
# Generated by export_simulation on Fri Aug 03 20:09:56 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './axi_sim.sh' script.

./axi_sim.sh -reset_run
...
./axi_sim.sh -noclean_files

For more information on the script, please type './axi_sim.sh -help'.
